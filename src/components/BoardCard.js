  ...
  return (
    ...
    {data.map((info)=>(
      ...
      <div className=' flex sm:m-4 md:m-2 -mx-[w/2] font-custom justify-center scale-[0.85]'>
          ...
          <div className='text-lg ml-5 mr-2 mt-5 font-bold text-secondary border-2 rounded-xl border-highlight p-4 bg-primary tracking-tight'>
