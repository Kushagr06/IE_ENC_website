...
function EventCards() {
  return (
    <div className='flex justify-center items-center align-middle sm:scale-100 scale-75'>
    {/* Card */}
     <div className=' container w-[28rem] h-64 bg-secondary rounded-2xl border-4 border-primary m-5'> 
     <div className='flex flex-row'>
      {/* pic */}
      <div className='top-0 left-0 w-[21rem] h-44 bg-black rounded-2xl ml-2 mt-2 mr-4'></div>
