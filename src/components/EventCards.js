...
function EventCards() {
 ...
 data.map((data)=>(       
  ...
  <div className='container w-[24rem] h-64 bg-secondary rounded-2xl border-4 border-primary sm:scale-100 scale-[0.85] sm:m-5 ' key={data.id}> 
  <div className='flex flex-row justify-center'>
  <div className='top-0 left-0 w-[75px] h-[75px] bg-primary rounded-full ml-2 text-textcol font-semibold  overflow-auto text-center align-middle mt-4 text-lg relative'>
   ...
   {/* name&description */}
   <div className='top-0 left-0 w-[21rem] h-12 bg-primary rounded-2xl ml-2 mt-2 text-highlight font-custom font-semibold text-lg overflow-auto text-center flex justify-center '>
     {data.name}:
