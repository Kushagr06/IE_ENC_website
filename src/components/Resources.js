...
export default class Resources extends Component {
  ...
  render() {
  return (
    <div className='pb-20' id="Resources">
    <div className='mx-5'>
    ...
    <div className='flex justify-center mt-12'>
      <div className='sm:w-[60%] w-[75%] m-10 p-20 h-auto bg-primary rounded-2xl border-4 border-secondary align-middle flex justify-around text-[2.5vh] text-secondary md:flex-row flex-col font-medium relative overflow-clip'>
        <img src={Flower} alt="" id="stamp"  className='absolute -top-[16vh] -left-[16vh] sm:scale-100 scale-[.65]'/>
        <img src={Globe} alt="" id="stamp"  className='absolute -bottom-[16vh] -right-[16vh] sm:scale-100 scale-[.65]'/>
    ...
    <label>
      <div className="text-[4.5vh] font-custom  font-semibold inline-block ml-[10vh] mt-10 px-2 mb-10">
   ...
   <div className=' w-full -mt-12 opacity-[0.75]'>
   <Wave
      fill='#DABFFF'
      paused={false}
      options={{
    ...
    <div className='text-center items-center align-middle text-secondary text-lg font-medium pt-16'>
      <span className='flex justify-center'><img src={Heart} alt="<3" onClick={ScrolltoTop} className=' hover:cursor-pointer'/></span>
